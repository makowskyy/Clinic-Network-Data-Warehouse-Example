...
GROUP BY CUBE(w.id_wojewodztwo, l.id_lekarza, r.id_leku)
...
GROUP BY CUBE(pow.id_powiat, s.id_specjalizacji, b.id_badania)
...
GROUP BY CUBE(g.id_gmina, s.id_specjalizacji, d.id_diagnozy)
