...
sqlldr %CONNECT_STRING% control=CTL\dzien.ctl skip=1 log=CTL\LOG\dzien.log bad=CTL\BAD\dzien.bad
sqlldr %CONNECT_STRING% control=CTL\miesiac.ctl skip=1 log=CTL\LOG\miesiac.log bad=CTL\BAD\miesiac.bad
sqlldr %CONNECT_STRING% control=CTL\rok.ctl skip=1 log=CTL\LOG\rok.log bad=CTL\BAD\rok.bad
...
sqlldr %CONNECT_STRING% control=CTL\status.ctl skip=1 log=CTL\LOG\status.log bad=CTL\BAD\status.bad
